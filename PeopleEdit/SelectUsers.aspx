...
<head runat="server">
    <title></title>
    <script src="../JsControl/jquery-easyui-1.2.5/jquery-1.7.1.min.js" type="text/javascript"></script>
    <script src="../JsControl/jquery-easyui-1.2.5/jquery.easyui.min.js" type="text/javascript"></script>
    <link href="../JsControl/jquery-easyui-1.2.5/themes/gray/easyui.css" rel="stylesheet"
        type="text/css" />
    <link href="../JsControl/jquery-easyui-1.2.5/themes/gray/tree.css" rel="stylesheet"
        type="text/css" />
    <link href="../JsControl/jquery-easyui-1.2.5/themes/gray/layout.css" rel="stylesheet"
        type="text/css" />
    <script src="../Scripts/peopleEdit.js" type="text/javascript"></script>
</head>
<style type="text/css">
    #tb_userinfo td
    {
...
<script type="text/javascript">
    $(function () {
        ...
        $('#OUTreeViewContainer').tree({
            lines: true,
            animate: true,
            url: '../ashx/OUTreeViewHandler.ashx',
